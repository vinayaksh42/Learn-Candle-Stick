            ...
            <Grid item xs={3.5} md={7.5} sm={4}>
              <div class="Learn Candlestick-logo">
                <h1>
                  ...
                  <img
                    id="learnstickswhite"
                    alt="learnstickswhite"
                    src="learnsticks white.png"
                    className="learnstick-whitelogo"
                  ></img>
                </h1>
              </div>
            </Grid>
        ...
        <div class="grid-container">
          <div className="row">
            <p className="copyright">
              &copy;{new Date().getFullYear()} Learn Candlestick | All rights
              reserved | Privacy
            </p>
          </div>
        </div>
