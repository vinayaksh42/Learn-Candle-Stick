export const data = [
  ...
  },
  {
    ...
    description:
      "The Three Inside Up is multiple candlestick pattern which is formed after a downtrend indicating bullish reversal. It consists of three candlesticks, the first being a long bearish candle, the second candlestick being a small bullish candle which should be in the range the first candlestick. The third candlestick should be a long bullish candlestick confirming the bullish reversal. The relationship of the first and second candlestick should be of the bullish harami candlestick pattern. Traders can take a long position after the completion of this candlestick pattern.",
  ...
  },
  {
    ...
    name: "Three Inside Up",
    description:
      "The Three Outside Up is multiple candlestick pattern which is formed after a downtrend indicating bullish reversal. It consists of three candlesticks, the first being a short bearish candle, the second candlestick being a large bullish candle which should cover the first candlestick.The third candlestick should be a long bullish candlestick confirming the bullish reversal.The relationship of the first and second candlestick chart should be of the Bullish Engulfing candlestick pattern.Traders can take a long position after the completion of this candlestick pattern.",
    image: "ThreeInsideUp.png",
    image1: "ThreeInsideUpstock.png",
  },
  {
  ...
  },
  {
    ...
    description:
      "Traders can enter a long position if next day a bearish candle is formed and can place a stop-loss at the high of the second candle.Below is an example of the Evening Star Candlestick Pattern",
  ...
  },
  {
    ...
    description:
      "lorem ipThe bearish counterattack candlestick pattern is a bearish reversal pattern that appears during an uptrend in the market. It predicts that the current uptrend in the market will make and the new downtrend will take over the market. um dolor",
  ...
  },
  {
    ...
    name: "Falling Window",
    description:
      "The falling window is a candlestick pattern that consists of two bearish candlesticks with a gap between them. The gap is a space between the high and low of two candlesticks. it occurs due to high trading volatility. It is a trend continuation candlestick pattern and it is an indication of the strong strength of sellers in the market.",
